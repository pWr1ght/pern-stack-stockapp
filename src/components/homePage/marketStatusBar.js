    ...
    return (
        <div>
            <div className="spacerBarFlexEnd" style={{marginBottom: "40px"}}>
                {marketStatus ? <div style={{color: 'green', marginRight: "20px", marginBottom: "-20px"}}><h4 style={{lineHeight: "1.6"}}>Market Open</h4></div> : <div style={{color: 'red', marginRight: "20px", marginBottom: "-20px"}}><h4 style={{lineHeight: "1.6"}}>Market Closed</h4></div> }
            </div>
        </div>
    )
}
